...
check_for_update() {
  ...
  local api_url="https://api.github.com/repos/filiphric/ai-powered-quality-engineering-with-cursor/releases/latest"
  ...
  local chapter_branches=(
    ...
    "chapter/05-workflow-building"
    "chapter/06-ai-code-governance"
  )
